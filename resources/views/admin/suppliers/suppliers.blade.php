    ...
    <div class="content-wrapper" id="app">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 font-weight-bold">suppliers Page</h1>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title fs-5 font-weight-bold" id="exampleModalLabel">Supplier</h3>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a @click="showModal('add')" href="#" class="btn btn-primary">
                                    <i class="fa fa-plus-circle" aria-hidden="true"></i> Add Supplires
                                </a>
                            </div>
                            <div class="card-body">
...
<script>
    var app = new Vue({
        ...
        methods: {
            ...
            getDelete(customer) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        axios.post('/admin/delete-suppliers', { id: customer.id })
                            .then(response => {
            ...
            editCustomer() {
                let vm = this;
                axios.post('/admin/edit-suppliers', vm.form)
                    .then(response => {
                        if (response.status === 200) {
                            vm.resetForm();
                            vm.fetchsuppliers();
            ...
            addCustomer() {
                let vm = this;
                axios.post('/admin/add-suppliers', vm.form)
                    .then(response => {
                        if (response.status === 200) {
                            vm.resetForm();
                            vm.fetchsuppliers();
