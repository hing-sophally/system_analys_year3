    ...
    <div class="content-wrapper" id="app">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 font-weight-bold">Customers Page</h1>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title fs-5 font-weight-bold" id="exampleModalLabel">Customer</h3>
                        ...
                        <div class="card-body">
                            <form action="" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input v-model="form.point" type="number" class="form-control" id="point" name="point" required>
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    var app = new Vue({
        ...
        methods: {
            ...
            resetForm() {
                ...
                this.form.point = 0; // Default to 0
            },
            getDelete(customer) {
                let vm = this;
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        axios.post('/admin/delete-customers', { id: customer.id })
                            .then(response => {
            ...
            editCustomer() {
                let vm = this;
                axios.post('/admin/edit-customers', vm.form)
                    .then(response => {
                        if (response.status === 200) {
                            vm.resetForm();
                            vm.fetchCustomers();
            ...
            addCustomer() {
                let vm = this;
                axios.post('/admin/add-customers', vm.form)
                    .then(response => {
                        if (response.status === 200) {
                            vm.resetForm();
                            vm.fetchCustomers();
